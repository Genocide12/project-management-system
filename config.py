...
# -*- coding: utf-8 -*-
"""
Configuration module for Project Management System.

Handles application settings, database configuration, user preferences,
theme/UI settings, and localization.
"""
